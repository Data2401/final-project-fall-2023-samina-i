...
```
This shows that countries need more support to increase the literacy rate.
...
Now, lets examine and break down by region. Chart below represent the trend over the years by region and it shows that few region's data are all over the place.
